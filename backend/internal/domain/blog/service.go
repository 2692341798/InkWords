...
func (s *Service) GetSeriesBlogs(ctx context.Context, parentID uuid.UUID, userID uuid.UUID) ([]model.Blog, error) {
...
func (s *Service) CreateDraftBlog(ctx context.Context, userID uuid.UUID) (model.Blog, error) {
	blog := model.Blog{
		UserID:      userID,
		ParentID:    nil,
		ChapterSort: 0,
