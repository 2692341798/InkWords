...
// PolishRequest represents the request body for polishing a blog draft.
...
// ScanStreamHandler handles the /api/v1/stream/scan endpoint
...
// PolishBlogStreamHandler handles the /api/v1/blogs/:id/polish endpoint.
