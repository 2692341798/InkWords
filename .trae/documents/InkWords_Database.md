...
## 0. 变更记录
- 2026-06-08：执行一次文档与仓库治理同步：刷新 `README.md`、补充 `docs/superpowers/*` 设计/计划文档，并移除仓库内旧的 `CODE_OF_CONDUCT.md` 与 `skills/llm-wiki-ingest/*` 文档资产；本次不涉及 PostgreSQL 表结构、字段、索引、迁移或数据库写入语义变更。
