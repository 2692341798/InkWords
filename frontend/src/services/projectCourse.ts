...
export const projectCourseService = {
  ...
  coverage(courseId: string) {
    return requestJson<ApiResponse<Record<string, unknown>>>(apiRoutes.coreApi.projectCourses.coverage(courseId), { method: 'GET', fallbackMessage: '获取课程覆盖报告失败' })
  },
